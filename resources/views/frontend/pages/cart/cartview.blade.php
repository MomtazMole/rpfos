        ...
        <div class="row no-gutters">
            <div class="col-md-8">
                <div class="product-details mr-2">
                    ...
                    <div>
                    <button type="submit" class="btn btn-outline-primary" data-mdb-ripple-init>Fresh cart</button>
                    </div>
            ...
            <div class="d-flex justify-content-between information"><span>Subtotal</span><span>{{ $subtotal }} BDT</span></div>
                    ...
                    <a href="{{route('checkout')}}" class="btn btn-info btn-block d-flex justify-content-between mt-3" type="button"><span>Checkout<i class="fa fa-long-arrow-right ml-1"></i></span></a></div>
        </div>
    </div>
@endsection